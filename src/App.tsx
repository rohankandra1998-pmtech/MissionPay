...
export default function App() {
  ...
  return <AuthProvider><a href="#main-content" className="skip-link">Skip to content</a>{!dashboard && !auth && <Header />}<div id="main-content"><Suspense fallback={<main className="chapter container"><LoadingState label="Opening MissionPay" /></main>}><Routes><Route path="/" element={<LandingPage />} /><Route path="/campaigns" element={<CampaignsPage />} /><Route path="/campaigns/:slug" element={<CampaignDetailPage />} /><Route path="/donate/:campaignId" element={<DonatePage />} /><Route path="/donation/:donationId/success" element={<DonationStatusPage />} /><Route path="/manage-donation/:token" element={<ManageDonationPage />} /><Route path="/login" element={<AuthPage mode="login" />} /><Route path="/signup" element={<AuthPage mode="signup" />} /><Route element={<ProtectedRoute />}><Route path="/dashboard" element={<DashboardPage />} /><Route path="/dashboard/campaigns" element={<DashboardPage section="campaigns" />} /><Route path="/dashboard/donations" element={<DashboardPage section="donations" />} /><Route path="/dashboard/campaigns/new" element={<CampaignEditorPage />} /><Route path="/dashboard/campaigns/:id" element={<CampaignEditorPage />} /></Route><Route path="*" element={<NotFoundPage />} /></Routes></Suspense></div>{!dashboard && !auth && <Footer />}</AuthProvider>;
}
